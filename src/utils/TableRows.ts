export const rows = [
  ...
  { cell: 8, attemp: [], correctNumbers: 0, correctPositions: 0 },
  { cell: 9, attemp: [], correctNumbers: 0, correctPositions: 0 },
  { cell: 10, attemp: [], correctNumbers: 0, correctPositions: 0 },
  { cell: 11, attemp: [], correctNumbers: 0, correctPositions: 0 },
  { cell: 12, attemp: [], correctNumbers: 0, correctPositions: 0 },
  { cell: 13, attemp: [], correctNumbers: 0, correctPositions: 0 }
]
